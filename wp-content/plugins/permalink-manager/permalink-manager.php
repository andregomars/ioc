	...
	*/
	public function default_alerts($alerts) {
		$default_alerts = apply_filters('permalink-manager-default-alerts', array(
			'june-2017' => array(
				'txt' => sprintf(__("Need to change the permalinks for categories, tags, custom taxonomies or WooCommerce?<br /><strong>Buy Permalink Manager Pro <a href=\"%s\" target=\"_blank\">here</a> and save 25&#37; using \"JUNE\" coupon code!</strong>", "permalink-manager"),
