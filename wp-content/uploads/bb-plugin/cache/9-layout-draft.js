var FLBuilderLayoutConfig = {
	...
	paths : {
		pluginUrl : 'http://52.33.60.220/ioc/wp-content/plugins/beaver-builder-lite-version/',
		wpAjaxUrl : 'http://52.33.60.220/ioc/admin/admin-ajax.php'
	}
};(function($){
...
})(jQuery);var wpAjaxUrl = 'http://52.33.60.220/ioc/admin/admin-ajax.php';var flBuilderUrl = 'http://52.33.60.220/ioc/wp-content/plugins/beaver-builder-lite-version/';; if(typeof FLBuilder !== 'undefined' && typeof FLBuilder._renderLayoutComplete !== 'undefined') FLBuilder._renderLayoutComplete();