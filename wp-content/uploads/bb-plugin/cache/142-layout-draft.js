...
var FLBuilderLayoutConfig={anchorLinkAnimations:{duration:1000,easing:'swing',offset:100},paths:{pluginUrl:'http://52.33.60.220/ioc/wp-content/plugins/beaver-builder-lite-version/',wpAjaxUrl:'http://52.33.60.220/ioc/admin/admin-ajax.php'}};(function($){if(typeof FLBuilderLayout!='undefined'){return;}
...
{var field=$(this);field.removeClass('fl-form-error');field.siblings('.fl-form-error-message').hide();}};$(function(){FLBuilderLayout.init();});})(jQuery);var wpAjaxUrl='http://52.33.60.220/ioc/admin/admin-ajax.php';var flBuilderUrl='http://52.33.60.220/ioc/wp-content/plugins/beaver-builder-lite-version/';;if(typeof FLBuilder!=='undefined'&&typeof FLBuilder._renderLayoutComplete!=='undefined')FLBuilder._renderLayoutComplete();